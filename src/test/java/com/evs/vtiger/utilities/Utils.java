...
public class Utils {
	...
	public static void createExtentReport() {
		...
		ExtentSparkReporter extSpark = new ExtentSparkReporter(
				System.getProperty("user.dir") + "/Reports/" + date + "VtigerAutomationReports.html");
		extSpark.config().setDocumentTitle("Vtiger Automation Reports");
	...
	public void alertAcceptPop() {
		...
		extTest.log(Status.INFO, "Successfull : Accepted Alert pop");
	}
	...
	public void checkedCheckBox(WebElement we) {
		try {
			...
			extTest.log(Status.FAIL, " Due to exception   check Box is checked");
	...
	public void clear(WebElement we) {
		...
		try {
			...
			// WebElement we = searchElementOnHTML(locator, elementName);
			we.clear();
			extTest.log(Status.INFO, "Successfully will  clear[" + elementName + "]  text box ");
		} catch (Exception e) {
			extTest.log(Status.FAIL, "Due to exception will  clear[" + elementName + "]  text box ");
			throw e;
		}
	}
	...
	public String getAttribute(WebElement we, String attributeName) {
		...
		try {
			...
			extTest.log(Status.INFO, "Due to exception not Fetch " + elementName + "attribute value ");
			e.printStackTrace();
		}
	...
	public void verifyElementCheckBixChecked(WebElement we) {
		try {
